...
Complete usage instructions are available on my [wiki](http://wiki.kjodle.net/D12_MLA_Citations_Documentation).

Want to see it in action? Check out [the demo](http://demo.kjodle.net/wordpress/plugins/d12-mla-citations/).
...
= 2.2 =
* Added superscript option, since that feature was removed from the TinyMCE editor
...
= 2.2 =
Miss having the superscript option as part of the TinyMCE editor? This plugin now has that function in a shortcode.
